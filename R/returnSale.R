...
#'
#' @examples
#' returnSaleByNumber(9B6F803F-9D37-41A2-BDA0-70A7179AF0F3,R202304110001)
returnSaleByNumber<- function(token,FNumber){
  #注册python模板
  mdl <- tsda::import('mdlCpEcsBillpy.newFunc')

  res <- mdl$returnSaleByNumber(token,FNumber)
  #返回结果
  return(res)
